...
A separate set of guides address a series of [fast follow-on capabilities](../2-fast-follow-on/README.md) that might be required up front depending on your organization's needs.
